...
export default function HeroSection() {
  ...
  const socialLinks = [
    {
      icon: Github,
      href: "https://github.com/rafaarkanarifki",
      label: "GitHub",
    },
    
    { icon: Youtube, href: "https://youtube.com/", label: "YouTube" },
    { icon: Instagram, href: "https://www.instagram.com/rafaarkana_21?igsh=MXI3d3JueDA4NmJybg==", label: "Instagram" },
  ];
  return (
    <section
      id="home"
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
          ...
          <div className="max-w-2xl text-center lg:text-left">
            ...
            >
              <span className="text-gradient">Rafa arkana rifki </span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-lg md:text-xl text-biru-foreground leading-relaxed mb-8"
            >
             saya siswa man 1 banda aceh,kelas pre internasional
             saya sedang belajar tentang pemograman coding yg berguna di era ini
            </motion.p>
