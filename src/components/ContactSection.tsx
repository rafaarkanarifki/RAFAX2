...
const contactInfo = [
  {
    icon: Mail,
    label: 'Email',
    value: 'rafaarkanarifki217@gmail.com',
    href: 'mailto:rafaarkanarifki217@gmail.com',
  },
  {
    icon: Phone,
    label: 'Telepon',
    value: '+62 82170356062',
    href: 'tel:+6282170356062',
  },
  {
    icon: MapPin,
    label: 'Lokasi',
    value: 'b.aceh, Indonesia',
    href: '#',
  },
]
          ...
          >
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Sedang merencanakan project baru atau mencari partner untuk
                berkolaborasi? Mari berdiskusi. Saya selalu terbuka untuk
                ide kreatif, tantangan baru, dan kesempatan untuk
                membangun sesuatu yang berdampak bersama.
              </p>
